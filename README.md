...
> **Results-driven DevOps & Cloud Engineer** with **6+ years of experience** architecting and automating CI/CD pipelines, cloud infrastructure, and deployments at enterprise scale.

- 🏢 Currently working as **Technology Lead @ Infosys** (supporting Bank of America)
- 🌩️ Specializing in **AWS, Kubernetes, Docker, Terraform & Ansible**
- 🔄 Passionate about **Automation, Continuous Integration & Delivery**
...
![Route53](https://img.shields.io/badge/Route53-8C4FFF?style=for-the-badge&logo=amazon-aws&logoColor=white)
...
| 🏆 Achievement | 📊 Impact |
|---|---|
| Reduced system downtime | **50% decrease** via proactive monitoring & incident response |
| Improved delivery speed | **25% faster** through Agile methodologies |
| Optimized server performance | **40% reduction** in server response time |
| CI/CD pipeline automation | Streamlined deployments across Dev, QA, UAT & Production |
| CD onboarding at Bank of America | End-to-end ownership from config to production |
...
- 🎓 **B.Tech in Electrical, Electronics & Communications Engineering** — JNTU *(2013–2017)*
...
- ✅ ISG Training: Phishing, Data Leakage, Policies & More
...
<p align="center">
  <a href="https://www.linkedin.com/in/swaroop-u">
